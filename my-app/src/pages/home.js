    ...
    render(){
       ...
       <div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-7 col-xs-12">
                                <div class="toolbar-contact">
                                    <ul>
                                        <li><i class="fa fa-envelope-o"></i><a href="mailto:support@sobhags.com">support@sobhags.com</a></li>
                                        <li><i class="fa fa-phone"></i><a href="tel:+91 9910252985">+91 9910252985</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="logo-area">
                                    <a class=" desktop" href="index.html">
                                        <img src="assets/images/sobhagsWebpLogo.webp" alt="logo"/></a>
                                    <a class=" phone" href="index.html"><img src="assets/images/favicon.ico.png" alt="logo"/></a>
                                </div>
                            </div>
                            <div class="col-lg-9 mobile-menu-area f-right">
                                <a class="readon radius " href="#"><i class="fa fa-user-o"></i>   signin/signup</a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="slider-image ">
                                            <div class="row rs-vertical-bottom">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0 pr-10">
                                                    <div class="animate1">
                                                        <img data-animation-in="bounceInRight" data-animation-out="animate-out fadeOut" src="assets/images/slider/sl1-ly1.png" alt="layer image"/>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0 pr-0">
                                                    <img data-animation-in="bounceInRight" data-animation-out="animate-out fadeOut" src="assets/images/slider/sl1-ly2.png" alt="layer image"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="container">                
                    <div class="row align-items-center">
                        ...
                        <div class="about-video-img">
                                <img src="assets/images/about/about-video-part.png" alt=""/>
                        </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row neuron-count">
                        <div class="col-lg-3 col-md-6 md-mb-30">
                            <div class="neuron-counter-part text-center">
                                <div class="shape-img">
                                    <img src="assets/images/counter/count-shape.png" alt=""/>
                                </div>
                ...
                <div class="container">
                    <ul class="partner-image-part">
                        <li class="partner-item mb-60">
                            <a href="#"><img src="assets/images/partner/1.png" alt="Partner Image"/></a>
                        </li>
                        <li class="partner-item mb-60">
                            <a href="#"><img src="assets/images/partner/2.png" alt="Partner Image"/></a>
                        </li>
                        <li class="partner-item mb-60">
                            <a href="#"><img src="assets/images/partner/3.png" alt="Partner Image"/></a>
                        </li>
                        <li class="partner-item mb-60">
                            <a href="#"><img src="assets/images/partner/4.png" alt="Partner Image"/></a>
                        </li>
                        <li class="partner-item mb-60">
                            <a href="#"><img src="assets/images/partner/5.png" alt="Partner Image"/></a>
                        </li>
            ...
            <div id="neuron-contact" class="neuron-contact contact-bg pb-100 md-pb-80">
                            ...
                            <div class="contact-info box-shadow">
                                ...
                                <div class="contact-icon">
                                    ...
                                    <div class="icon-text">
                                        ...
                                        <p>76-D, Pocket A/2, Mayur Vihar Phase-III, Delhi, Pin-110096</p>
                                    </div>
                                </div>
                                <div class="contact-icon">
                                    <div class="icon-part">
                                    ...
                                    <div class="icon-text">
                                        ...
                                        <a href="tel:+91 8368 869 734">+91 8368 869 734</a>
                                        <a href="tel:+91 9910252985">+91 9910 252 985</a>
                                    </div>
                                </div>
                                <div class="contact-icon">
                                    <div class="icon-part">
                                    ...
                                    <div class="icon-text">
                                        ...
                                        <a href="mailto:support@sobhags.com">support@sobhags.com</a>
                                        <a href="#">https://sobhags.club</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.7034822711585!2d77.3322563150821!3d28.608670982427135!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce56fc266ed0d%3A0x3abd1c97109d0ba5!2sSOBHAGS%20MARKETING%20PRIVATE%20LIMITED!5e0!3m2!1sen!2sin!4v1606288995184!5m2!1sen!2sin" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
                </div>
                ...
                <div class="footer-bottom">
                    <div class="container">                    
                        <div class="copyright text-center">
                            ...
                            <p>©  Powered By <a href="#"> <b>Estivasoftech</b></a></p>
                        </div>
                    </div>
                </div>
            </footer>
